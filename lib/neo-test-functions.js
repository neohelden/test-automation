() => {
  ...
  const showsAdaptiveCard = (adaptiveCardContent, { elementNumber = null } = {}) => {
    ...
    fuzzyDataSearchTest(restrictedParticle.response.content, adaptiveCardContent)
  }
  ...
  const showsDownload = (url, { elementNumber = null } = {}) => {
    ...
    fuzzyDataSearchTest(restrictedParticle.response.content, url)
  }
  ...
  const showsExpandable = ({ title = null, html = null, elementNumber = null } = {}) => {
    ...
    if (title) fuzzyDataSearchTest(restrictedParticle.response.content, title)
    if (html) fuzzyDataSearchTest(restrictedParticle.response.content, html)
  }
  ...
  const showsHtml = (html, { elementNumber = null } = {}) => {
    ...
    fuzzyDataSearchTest(restrictedParticle.response.content, html)
  }
  ...
  const showsImage = (imageSource, { elementNumber = null } = {}) => {
    ...
    fuzzyDataSearchTest(restrictedParticle.response.content, imageSource)
  }
  ...
  const showsMap = ({ lat = null, lng = null, elementNumber = null } = {}) => {
    ...
    if (lat) fuzzyDataSearchTest(restrictedParticle.response.content, lat)
    if (lng) fuzzyDataSearchTest(restrictedParticle.response.content, lng)
  }
  ...
  const showsMedia = (mediaUrl, { elementNumber = null } = {}) => {
    ...
    fuzzyDataSearchTest(restrictedParticle.response.content, mediaUrl)
  }
  ...
  const showsText = (text, { elementNumber = null } = {}) => {
    ...
    fuzzyDataSearchTest(restrictedParticle.response.content, text)
  }
  ...
  const triggersAudio = (url, { elementNumber = null } = {}) => {
    ...
    fuzzyDataSearchTest(restrictedParticle.response.directives, url)
  }
  ...
  const triggersCamera = ({ target = null, mode = null, elementNumber = null } = {}) => {
    ...
    if (target) fuzzyDataSearchTest(restrictedParticle.response.content, target)
    if (mode) fuzzyDataSearchTest(restrictedParticle.response.content)
  }
  ...
  const triggersUpload = (target, { elementNumber = null } = {}) => {
    ...
    fuzzyDataSearchTest(restrictedParticle.response.content, target)
  }
  ...
  const doesCopyToClipboad = (text, { elementNumber = null } = {}) => {
    ...
    fuzzyDataSearchTest(restrictedParticle.response.directives, text)
  }
  ...
  const doesComposeAnEmail = ({ recipients = null, subject = null, body = null, elementNumber = null } = {}) => {
    ...
    if (recipients) fuzzyDataSearchTest(restrictedParticle.response.directives, recipients)
    if (subject) fuzzyDataSearchTest(restrictedParticle.response.directives, subject)
    if (body) fuzzyDataSearchTest(restrictedParticle.response.directives, body)
  }
  ...
  const doesPhoneCall = (number, { elementNumber = null } = {}) => {
    ...
    fuzzyDataSearchTest(restrictedParticle.response.directives, number)
  }
